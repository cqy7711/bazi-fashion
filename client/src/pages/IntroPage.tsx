              ...
              <div style={{ paddingTop: '16px' }}>
                ...
                >
                  {FIVE_ELEMENTS.map((el, i) => (
                    ...
                    >
                      <span style={{ fontSize: '12px', marginBottom: '3px' }}>{el.symbol}</span>
                      <span style={{ fontSize: '22px', fontWeight: 900, color: el.color, lineHeight: 1, fontFamily: 'Outfit, sans-serif' }}>
                        {el.name}
                      </span>
                      <span style={{ fontSize: '9px', color: 'rgba(255,255,255,0.5)', marginTop: '3px', fontFamily: 'Outfit' }}>
                        {el.desc}
                      </span>
                    </motion.div>
                  ))}
                ...
                >
                  <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '10px' }}>
                    ...
                    <span style={{ fontFamily: 'Outfit, sans-serif', fontSize: '14px', fontWeight: 700, color: '#FFE0CC' }}>
                      不只是算命，是生活指南
                    </span>
                  </div>
                  <p style={{
                    fontSize: '13px', lineHeight: 1.8, color: 'rgba(255,255,255,0.6)',
                ...
                <div style={{ display: 'grid', gap: '10px', textAlign: 'left' }}>
                  {STEPS.map((s, i) => (
                    ...
                    >
                      ...
                      <div>
                        <p style={{ margin: 0, fontFamily: 'Outfit, Noto Sans SC, sans-serif', fontSize: '13px', fontWeight: 700, color: '#FFFFFF' }}>
                          {s.title}
                        </p>
                        <p style={{ margin: '2px 0 0', fontFamily: 'Outfit, Noto Sans SC, sans-serif', fontSize: '11px', color: 'rgba(255,255,255,0.5)' }}>
                          {s.desc}
                        </p>
                      </div>
                    </motion.div>
      ...
      <AnimatePresence>
        {showContent && (
          ...
          >
            {/* 页码 */}
            <p style={{
              textAlign: 'center', fontSize: '11px', color: 'rgba(255,255,255,0.25)',
